...
#ifdef TECS_CLUB_FEATURES
	#include "TECS_CLUB/TECS_CLUB_FEATURES.h"
#endif
...
#define OLED_DISPLAY_SSD1306  // OLED Display Type: SSD1306(OLED_DISPLAY_SSD1306) / SH1106(OLED_DISPLAY_SH1106), comment this line out to disable oled
    ...
    #define OLED_PIN_SDA  21 // 2 // 4  //5 //SDA;  // i2c SDA Pin
    #define OLED_PIN_SCL  22 // 0 // 15  //4 //SCL;  // i2c SCL Pin
#else
    #define OLED_PIN_SDA  2 // 4  //5 //SDA;  // i2c SDA Pin
    #define OLED_PIN_SCL  0 // 15  //4 //SCL;  // i2c SCL Pin
#endif
...
const char DEFAULT_AP_SSID []  PROGMEM =        "ESP3D-KNU";
const char DEFAULT_AP_PASSWORD [] PROGMEM = "12345678";
const char DEFAULT_STA_SSID []  PROGMEM =       "ESP3D-KNU";
